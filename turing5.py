...
# This Turing Machine decides the language { w | w contains twice as many 0s as 1s }
...
tm5 = TuringMachine(states, input_alphabet, tape_alphabet, transition_function, start_state, accept_state, reject_state)
